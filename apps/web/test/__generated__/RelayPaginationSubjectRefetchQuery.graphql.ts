/**
 * @generated SignedSource<<6a5fed750995a9ccb2047ee4dabd5858>>
...
export type RelayPaginationSubjectRefetchQuery$variables = {
  count: number;
  cursor?: any | null | undefined;
  id: string;
};
export type RelayPaginationSubjectRefetchQuery$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"RelayPaginationSubjectFragment">;
  } | null | undefined;
};
export type RelayPaginationSubjectRefetchQuery = {
  response: RelayPaginationSubjectRefetchQuery$data;
  variables: RelayPaginationSubjectRefetchQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "RelayPaginationSubjectRefetchQuery",
    "selections": [
      {
        "alias": null,
        "args": (v1/*:: as any*/),
